...
ffi.cdef [[
  ...
  typedef union cairo_path_data_t {
    struct {
  ...
  typedef cairo_status_t (*cairo_write_func_t)(void *closure, unsigned char *data, unsigned int length);
  ...
  void cairo_get_dash(cairo_t*, double *dashes, double *offset);
  ...
  cairo_bool_t        cairo_in_clip                       (cairo_t*,
                                                           double x,
                                                           double y);
  ...
  cairo_bool_t        cairo_in_fill                       (cairo_t*,
                                                           double x,
                                                           double y);                                                         
  void                cairo_mask                          (cairo_t*,
                                                           cairo_pattern_t*);
  void                cairo_mask_surface                  (cairo_t*,
                                                           cairo_surface_t*,
                                                           double surface_x,
                                                           double surface_y);                                                         
  void                cairo_paint                         (cairo_t*);
  void                cairo_paint_with_alpha              (cairo_t*,
                                                           double alpha);
  void                cairo_stroke                        (cairo_t*);
  void                cairo_stroke_preserve               (cairo_t*);
  void                cairo_stroke_extents                (cairo_t*,
                                                           double *x1,
                                                           double *y1,
                                                           double *x2,
                                                           double *y2);
  ...
  cairo_status_t cairo_set_user_data(cairo_t*, const cairo_user_data_key_t*, void *user_data, cairo_destroy_func_t);
  ...
  void                cairo_arc                           (cairo_t*,
                                                           double xc,
                                                           double yc,
                                                           double radius,
                                                           double angle1,
                                                           double angle2);
  void                cairo_arc_negative                  (cairo_t*,
                                                           double xc,
                                                           double yc,
                                                           double radius,
                                                           double angle1,
                                                           double angle2);
  void                cairo_curve_to                      (cairo_t*,
                                                           double x1,
                                                           double y1,
                                                           double x2,
                                                           double y2,
                                                           double x3,
                                                           double y3);
  void                cairo_line_to                       (cairo_t*,
                                                           double x,
                                                           double y);
  void                cairo_move_to                       (cairo_t*,
                                                           double x,
                                                           double y);
  void                cairo_rectangle                     (cairo_t*,
                                                           double x,
                                                           double y,
                                                           double width,
                                                           double height);
  void                cairo_glyph_path                    (cairo_t*,
                                                           const cairo_glyph_t *glyphs,
                                                           int num_glyphs);
  void                cairo_text_path                     (cairo_t*,
                                                           const char *utf8);
  void                cairo_rel_curve_to                  (cairo_t*,
                                                           double dx1,
                                                           double dy1,
                                                           double dx2,
                                                           double dy2,
                                                           double dx3,
                                                           double dy3);
  void                cairo_rel_line_to                   (cairo_t*,
                                                           double dx,
                                                           double dy);
  void                cairo_rel_move_to                   (cairo_t*,
                                                           double dx,
                                                           double dy);
  ...
  void                cairo_pattern_add_color_stop_rgba   (cairo_pattern_t*,
                                                           ...
                                                           double blue,
                                                           double alpha);
  cairo_status_t      cairo_pattern_get_color_stop_count  (cairo_pattern_t*,
                                                           int *count);
  cairo_status_t      cairo_pattern_get_color_stop_rgba   (cairo_pattern_t*,
                                                           int index,
                                                           double *offset,
                                                           double *red,
                                                           double *green,
  ...
  cairo_pattern_t *   cairo_pattern_create_rgba           (double red,
                                                           ...
                                                           double blue,
                                                           double alpha);
  cairo_status_t      cairo_pattern_get_rgba              (cairo_pattern_t*,
                                                           double *red,
                                                           double *green,
                                                           double *blue,
                                                           double *alpha);
  cairo_pattern_t *   cairo_pattern_create_for_surface    (cairo_surface_t*);
  cairo_status_t      cairo_pattern_get_surface           (cairo_pattern_t*,
                                                           cairo_surface_t **surface);
  cairo_pattern_t *   cairo_pattern_create_linear         (double x0,
                                                           double y0,
                                                           double x1,
                                                           double y1);
  cairo_status_t      cairo_pattern_get_linear_points     (cairo_pattern_t*,
                                                           double *x0,
                                                           double *y0,
                                                           double *x1,
                                                           double *y1);
  cairo_pattern_t *   cairo_pattern_create_radial         (double cx0,
                                                           ...
                                                           double cy1,
                                                           double radius1);
  cairo_status_t      cairo_pattern_get_radial_circles    (cairo_pattern_t*,
                                                           double *x0,
                                                           double *y0,
                                                           double *r0,
                                                           double *x1,
  ...
  void                cairo_pattern_set_extend            (cairo_pattern_t*,
                                                           cairo_extend_t extend);
  cairo_extend_t      cairo_pattern_get_extend            (cairo_pattern_t*);
  void                cairo_pattern_set_filter            (cairo_pattern_t*,
                                                           cairo_filter_t filter);
  cairo_filter_t      cairo_pattern_get_filter            (cairo_pattern_t*);
  void                cairo_pattern_set_matrix            (cairo_pattern_t*,
                                                           const cairo_matrix_t *matrix);
  void                cairo_pattern_get_matrix            (cairo_pattern_t*,
  ...
  cairo_status_t      cairo_pattern_set_user_data         (cairo_pattern_t*,
                                                           const cairo_user_data_key_t *key,
                                                           void *user_data,
                                                           cairo_destroy_func_t destroy);
  void *              cairo_pattern_get_user_data         (cairo_pattern_t*,
                                                           const cairo_user_data_key_t *key);
  ...
  cairo_status_t      cairo_region_xor_rectangle          (cairo_region_t *dst,
                                                           const cairo_rectangle_int_t *rectangle);
  void                cairo_translate                     (cairo_t*,
                                                           double tx,
                                                           double ty);
  void                cairo_scale                         (cairo_t*,
                                                           double sx,
                                                           double sy);
  void                cairo_rotate                        (cairo_t*,
                                                           double angle);
  void                cairo_transform                     (cairo_t*,
                                                           const cairo_matrix_t *matrix);
  void                cairo_set_matrix                    (cairo_t*,
                                                           const cairo_matrix_t *matrix);
  void                cairo_get_matrix                    (cairo_t*,
                                                           cairo_matrix_t *matrix);
  void                cairo_identity_matrix               (cairo_t*);
  void                cairo_user_to_device                (cairo_t*,
                                                           double *x,
                                                           double *y);
  void                cairo_user_to_device_distance       (cairo_t*,
                                                           double *dx,
                                                           double *dy);
  void                cairo_device_to_user                (cairo_t*,
                                                           double *x,
                                                           double *y);
  void                cairo_device_to_user_distance       (cairo_t*,
                                                           double *dx,
                                                           double *dy);
  ...
  void                cairo_set_font_size                 (cairo_t*,
                                                           double size);
  void                cairo_set_font_matrix               (cairo_t*,
                                                           const cairo_matrix_t *matrix);
  void                cairo_get_font_matrix               (cairo_t*,
                                                           cairo_matrix_t *matrix);
  void                cairo_set_font_options              (cairo_t*,
                                                           const cairo_font_options_t *options);
  void                cairo_get_font_options              (cairo_t*,
                                                           cairo_font_options_t *options);
  void                cairo_set_font_face                 (cairo_t*,
  ...
  void                cairo_show_text                     (cairo_t*,
                                                           const char *utf8);
  void                cairo_show_glyphs                   (cairo_t*,
                                                           const cairo_glyph_t *glyphs,
                                                           int num_glyphs);
  void                cairo_show_text_glyphs              (cairo_t*,
                                                           const char *utf8,
                                                           int utf8_len,
                                                           const cairo_glyph_t *glyphs,
                                                           int num_glyphs,
  ...
  void                cairo_font_extents                  (cairo_t*,
                                                           cairo_font_extents_t *extents);
  void                cairo_text_extents                  (cairo_t*,
                                                           const char *utf8,
                                                           cairo_text_extents_t *extents);
  void                cairo_glyph_extents                 (cairo_t*,
                                                           const cairo_glyph_t *glyphs,
                                                           int num_glyphs,
                                                           cairo_text_extents_t *extents);
  ...
  void                cairo_surface_get_font_options      (cairo_surface_t*,
  ...
  void                cairo_surface_mark_dirty_rectangle  (cairo_surface_t*,
                                                           ...
                                                           int width,
                                                           int height);
  void                cairo_surface_set_device_offset     (cairo_surface_t*,
                                                           double x_offset,
                                                           double y_offset);
  ...
  cairo_status_t      cairo_surface_set_user_data         (cairo_surface_t*,
                                                           const cairo_user_data_key_t *key,
                                                           void *user_data,
                                                           cairo_destroy_func_t destroy);
  void *              cairo_surface_get_user_data         (cairo_surface_t*,
                                                           const cairo_user_data_key_t *key);
  ...
  cairo_status_t      cairo_surface_set_mime_data         (cairo_surface_t*,
                                                           const char *mime_type,
                                                           unsigned char *data,
                                                           unsigned long  length,
                                                           cairo_destroy_func_t destroy,
                                                           void *closure);
  void                cairo_surface_get_mime_data         (cairo_surface_t*,
                                                           const char *mime_type,
                                                           unsigned char **data,
                                                           unsigned long *length);
  ...
  void                cairo_pdf_surface_set_size          (cairo_surface_t*,
                                                           double width_in_points,
                                                           double height_in_points);
  ...
  cairo_surface_t *   cairo_image_surface_create_from_png_stream
                                                          (cairo_read_func_t read_func,
                                                           void *closure);
  cairo_status_t      cairo_surface_write_to_png          (cairo_surface_t*,
                                                           const char *filename);
  ...
  void                cairo_ps_surface_dsc_begin_page_setup
                                                          (cairo_surface_t*);
  void                cairo_ps_surface_dsc_comment        (cairo_surface_t*,
                                                           const char *comment);
  cairo_surface_t *   cairo_recording_surface_create      (cairo_content_t content,
                                                           const cairo_rectangle_t *extents);
  void                cairo_recording_surface_ink_extents (cairo_surface_t*,
                                                           double *x0,
                                                           double *y0,
                                                           double *width,
                                                           double *height);
...
if (ffi.os == 'Windows') then
  ...
  ffi.cdef [[
    ...
    cairo_surface_t *   cairo_win32_surface_get_image       (cairo_surface_t*);
