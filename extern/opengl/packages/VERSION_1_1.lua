return {
  inherits = {
    require 'extern.opengl.packages.VERSION_1_0';
  };
  typeAliases = {
  ...
  funcs = {
    ...
    {'GenTextures';
      'SizeI', 'n';
      'Texture*', 'textures'};
    {'IsTexture', ret='Boolean';
      'Texture', 'texture'};
    {'ArrayElement', deprecated='3.1';
      'Int32', 'i'};
    {'ColorPointer', deprecated='3.1';
      'Int32', 'size';
      'ColorPointerType', 'type';
      'SizeI', 'stride';
      'const Void*', 'pointer'};
    {'DisableClientState', deprecated='3.1';
      'EnableCap', 'array'};
    {'EdgeFlagPointer', deprecated='3.1';
      'SizeI', 'stride';
      'const Void*', 'pointer'};
    {'EnableClientState', deprecated='3.1';
      'EnableCap', 'array'};
    {'IndexPointer', deprecated='3.1';
      'IndexPointerType', 'type';
      'SizeI', 'stride';
      'const Void*', 'pointer'};
    {'InterleavedArrays', deprecated='3.1';
      'InterleavedArrayFormat', 'format';
      'SizeI', 'stride';
      'const Void*', 'pointer'};
    {'NormalPointer', deprecated='3.1';
      'NormalPointerType', 'type';
      'SizeI', 'stride';
      'const Void*', 'pointer'};
    {'TexCoordPointer', deprecated='3.1';
      'Int32', 'size';
      'TexCoordPointerType', 'type';
      'SizeI', 'stride';
      'const Void*', 'pointer'};
    {'VertexPointer', deprecated='3.1';
      'Int32', 'size';
      'VertexPointerType', 'type';
      'SizeI', 'stride';
      'const Void*', 'pointer'};
    {'AreTexturesResident', ret='Boolean', deprecated='3.1';
      'SizeI', 'n';
      'const Texture*', 'textures';
      'Boolean*', 'residences'};
    {'PrioritizeTextures', deprecated='3.1';
      'SizeI', 'n';
      'const Texture*', 'textures';
    ...
    {'Indexub';
      'ColorIndexValueUB', 'c'};
    {'Indexubv';
      'const ColorIndexValueUB*', 'c'};
    {'PopClientAttrib', deprecated='3.1'};
    {'PushClientAttrib', deprecated='3.1';
